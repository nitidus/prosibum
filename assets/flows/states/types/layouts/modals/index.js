module.exports = {
  ...
  CAMERA_ROLL_PICKER_MODAL: {
    ...
    APPEND_CAMERA_ROLL_ITEMS: 'CAMERA_ROLL_PICKER_MODAL/APPEND_CAMERA_ROLL_ITEMS',
    SET_CAMERA_ROLL_END_CURSOR: 'CAMERA_ROLL_PICKER_MODAL/SET_CAMERA_ROLL_END_CURSOR',
  ...
  PRODUCT_FEATURES_MODAL: {
    ...
    SET_CURRENT_HIDDEN_TAB_INDEX: 'PRODUCT_FEATURES_MODAL/SET_CURRENT_HIDDEN_TAB_INDEX',
    ...
    SET_PRODUCT_FEATURE_BASED_ON_PATTERN: 'PRODUCT_FEATURES_MODAL/SET_PRODUCT_FEATURE_BASED_ON_PATTERN',
    SET_PRODUCT_FEATURES_BASED_ON_PATTERN: 'PRODUCT_FEATURES_MODAL/SET_PRODUCT_FEATURES_BASED_ON_PATTERN',
    SET_SELECTED_UNIT: 'PRODUCT_FEATURES_MODAL/SET_SELECTED_UNIT',
    TOGGLE_DETACHABLE_UNIT: 'PRODUCT_FEATURES_MODAL/TOGGLE_DETACHABLE_UNIT',
    SET_DETACHABLE_PRICE: 'PRODUCT_FEATURES_MODAL/SET_DETACHABLE_PRICE',
    SET_MINIMUM_DETACHABLE_ORDER_QUANTITY: 'PRODUCT_FEATURES_MODAL/SET_MINIMUM_DETACHABLE_ORDER_QUANTITY',
    SET_MAXIMUM_DETACHABLE_ORDER_QUANTITY: 'PRODUCT_FEATURES_MODAL/SET_MAXIMUM_DETACHABLE_ORDER_QUANTITY',
    SET_SELECTED_WAREHOUSE: 'PRODUCT_FEATURES_MODAL/SET_SELECTED_WAREHOUSE',
    ...
    TOGGLE_INFINITE_MAXIMUM_ORDER_QUANTITY: 'PRODUCT_FEATURES_MODAL/TOGGLE_INFINITE_MAXIMUM_ORDER_QUANTITY',
    SET_QUANTITY: 'PRODUCT_FEATURES_MODAL/SET_QUANTITY',
    SET_DESCRIPTION: 'PRODUCT_FEATURES_MODAL/SET_DESCRIPTION',
    SET_PRICE: 'PRODUCT_FEATURES_MODAL/SET_PRICE',
    SET_SELECTED_SHIPPING_METHOD: 'PRODUCT_FEATURES_MODAL/SET_SELECTED_SHIPPING_METHOD',
    ...
    FETCH_AVAILABLE_PRODUCT_WAREHOUSES: 'PRODUCT_FEATURES_MODAL/FETCH_AVAILABLE_PRODUCT_WAREHOUSES',
    FETCH_AVAILABLE_PRODUCT_SHIPPING_METHODS: 'PRODUCT_FEATURES_MODAL/FETCH_AVAILABLE_PRODUCT_SHIPPING_METHODS',
    ...
    SET_FETCH_AVAILABLE_PRODUCT_WAREHOUSES_LOADING_STATUS: 'PRODUCT_FEATURES_MODAL/SET_FETCH_AVAILABLE_PRODUCT_WAREHOUSES_LOADING_STATUS',
    SET_FETCH_AVAILABLE_PRODUCT_SHIPPING_METHODS_LOADING_STATUS: 'PRODUCT_FEATURES_MODAL/SET_FETCH_AVAILABLE_PRODUCT_SHIPPING_METHODS_LOADING_STATUS',

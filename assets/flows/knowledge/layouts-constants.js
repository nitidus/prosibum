import languages_modal from './layouts/modals/languages-modal.json';
import countries_codes_modal from './layouts/modals/countries-codes-modal.json';
import camera_roll_picker_modal from './layouts/modals/camera-roll-picker-modal.json';
import role_modal from './layouts/modals/role-modal.json';
import wallet_modal from './layouts/modals/wallet-modal.json';
